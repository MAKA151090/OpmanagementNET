...
namespace HealthCare.Migrations
{
    ...
    [Migration("20240519100456_IntialV10FacilityMap")]
    partial class IntialV10FacilityMap
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DoctorScheduleModel", b =>
                {
                    ...
                    b.HasKey("PatientID", "FacilityID", "SlotsID");
            ...
            modelBuilder.Entity("HealthCare.Models.InPatientTransferUpdateModel", b =>
                {
                    ...
                    b.HasKey("PatientId", "CaseId", "BedId");
            ...
            modelBuilder.Entity("HealthCare.Models.InpatientObservationModel", b =>
                {
                    ...
                    b.HasKey("PatientID", "ObservationID", "BedNoID");
            ...
            modelBuilder.Entity("HealthCare.Models.ScreenMasterModel", b =>
                {
                    ...
                    b.Property<string>("ReadWriteAccess")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HealthCare.Models.UpdateRadiologyResultsModel", b =>
                {
                    ...
                    b.HasKey("PatientID", "FacilityID", "RadioID");
            ...
            modelBuilder.Entity("PatExmSymptomsSeverity", b =>
                {
                    ...
                    b.Property<string>("PatientExaminationModelFacilityID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("PatientID", "FacilityID", "VisitID", "ExaminationID", "Severity");

                    b.HasIndex("PatientExaminationModelPatientID", "PatientExaminationModelFacilityID", "PatientExaminationModelVisitID", "PatientExaminationModelExaminationID");
            ...
            modelBuilder.Entity("PatExmSymptomsSeverity", b =>
                {
                    b.HasOne("PatientExaminationModel", null)
                        .WithMany("Severity")
                        .HasForeignKey("PatientExaminationModelPatientID", "PatientExaminationModelFacilityID", "PatientExaminationModelVisitID", "PatientExaminationModelExaminationID");
                });
